...
const getCourseColor = (title: string, isCanvas: boolean, courseCode?: string, storedColors?: Record<string, string>) => {
  ...
  const courseColors = [
    'bg-red-100 dark:bg-red-900 border-red-300 dark:border-red-600 text-red-800 dark:text-red-100',
    'bg-blue-100 dark:bg-blue-900 border-blue-300 dark:border-blue-600 text-blue-800 dark:text-blue-100',
    'bg-green-100 dark:bg-green-900 border-green-300 dark:border-green-600 text-green-800 dark:text-green-100',
    'bg-purple-100 dark:bg-purple-900 border-purple-300 dark:border-purple-600 text-purple-800 dark:text-purple-100',
    'bg-orange-100 dark:bg-orange-900 border-orange-300 dark:border-orange-600 text-orange-800 dark:text-orange-100',
    'bg-yellow-100 dark:bg-yellow-900 border-yellow-300 dark:border-yellow-600 text-yellow-800 dark:text-yellow-100',
    'bg-indigo-100 dark:bg-indigo-900 border-indigo-300 dark:border-indigo-600 text-indigo-800 dark:text-indigo-100',
    'bg-pink-100 dark:bg-pink-900 border-pink-300 dark:border-pink-600 text-pink-800 dark:text-pink-100',
    'bg-teal-100 dark:bg-teal-900 border-teal-300 dark:border-teal-600 text-teal-800 dark:text-teal-100',
    'bg-cyan-100 dark:bg-cyan-900 border-cyan-300 dark:border-cyan-600 text-cyan-800 dark:text-cyan-100',
    'bg-emerald-100 dark:bg-emerald-900 border-emerald-300 dark:border-emerald-600 text-emerald-800 dark:text-emerald-100',
    'bg-lime-100 dark:bg-lime-900 border-lime-300 dark:border-lime-600 text-lime-800 dark:text-lime-100',
    'bg-amber-100 dark:bg-amber-900 border-amber-300 dark:border-amber-600 text-amber-800 dark:text-amber-100',
    'bg-rose-100 dark:bg-rose-900 border-rose-300 dark:border-rose-600 text-rose-800 dark:text-rose-100',
    'bg-violet-100 dark:bg-violet-900 border-violet-300 dark:border-violet-600 text-violet-800 dark:text-violet-100',
    'bg-fuchsia-100 dark:bg-fuchsia-900 border-fuchsia-300 dark:border-fuchsia-600 text-fuchsia-800 dark:text-fuchsia-100',
    'bg-sky-100 dark:bg-sky-900 border-sky-300 dark:border-sky-600 text-sky-800 dark:text-sky-100',
    'bg-slate-100 dark:bg-slate-900 border-slate-300 dark:border-slate-600 text-slate-800 dark:text-slate-100',
  ];
