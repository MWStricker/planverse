...
export const SortableTabItem = ({ 
  ...
  return (
    <Button
      ...
      className={`w-full h-14 text-base transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] ${
    ...
    >
      ...
      <Icon className={`h-5 w-5 transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] ${
        isCollapsed ? '' : 'mr-3'
      } ${
        isActive 
      ...
      {!isCollapsed && (
        <>
          <span className={`font-medium transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] ${
