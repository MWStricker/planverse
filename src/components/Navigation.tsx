  ...
  return (
    <div className="flex flex-col h-full bg-card border-r border-border relative">
      ...
      <Button
        ...
        className={`absolute -right-3 top-4 z-10 h-6 w-6 p-0 bg-card border border-border rounded-full hover:bg-muted/30 transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] ${
      ...
      <div className="p-4 pt-1 border-b border-border">
        <div className="flex items-center justify-between">
          <div className={`text-center flex-1 transition-all duration-400 ease-[cubic-bezier(0.23,1,0.32,1)] ${isCollapsed ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}>
            {!isCollapsed && (
              <>
