    ...
    <Card className="mb-6">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex items-center gap-4">
            <label htmlFor="post-type" className="text-sm font-medium text-muted-foreground whitespace-nowrap">Post Type</label>
            <NativeDropdown
        ...
        {isExpanded && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t">
            <div className="flex items-center gap-4">
              <label htmlFor="filter-major" className="text-sm font-medium text-muted-foreground whitespace-nowrap">Filter by Major</label>
              <NativeDropdown
            ...
            <div className="flex items-center gap-4">
              <label htmlFor="filter-school" className="text-sm font-medium text-muted-foreground whitespace-nowrap">Filter by School</label>
              <NativeDropdown
