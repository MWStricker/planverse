...
import coloradoStateRealLogo from '@/assets/university-logos/colorado-state-real.png';
...
export const universities: University[] = [
  ...
  createUniversity({ id: 'colorado-state', name: 'Colorado State University', shortName: 'Colorado State', logo: coloradoStateRealLogo, type: 'state', state: 'CO', isPublic: true }),
